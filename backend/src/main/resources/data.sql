INSERT INTO store ( name,  item,  url,  price,  photo) values ('민태', '바늘', 'ddd', 123, '사진')
INSERT INTO store (  name,  item,  url,  price,  photo) values ( '민태', '바늘', 'ddd', 123, '사진')
INSERT INTO store (  name,  item,  url,  price,  photo) values ( '민태', '바늘', 'ddd', 123, '사진')
INSERT INTO users (  user_id,  password,  nickname,  number,  user_img) values ( '민태', '바늘', '민태다', 123, '사진')
INSERT INTO users (  user_id,  password,  nickname,  number,  user_img) values ( '윤상', '찐따',  '허리', 123, '사진')
INSERT INTO article ( title, content) values ('민태', '바늘')
INSERT INTO article ( title, content) values ('민태123', '바늘123')
INSERT INTO article ( title, content) values ('민태123', '바늘123')
INSERT INTO article ( title, content) values ('민태123', '바늘123')
INSERT INTO cage ( id,cage_name, set_temp, set_hum, set_uv, created_at, category ) values (1,'케이지1',12,12,12,'2000-05-03','동물')
...
INSERT INTO animal (name, gender, birth, issue, created_at, photo) values ('조윤상 사는곳', '과d물', '2000-05-03','과dd물','2000-05-03','과asd물')
INSERT INTO animal (name, gender, birth, issue,created_at, photo) values ('김만웅 사는곳', '과d물', '2000-05-03','과dd물','2000-05-03','과asd물')
